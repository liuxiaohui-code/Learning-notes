...
// like Node.*/
  ...
  const xMutationObserver = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver;
  ...
  var hasObserver = xMutationObserver !== undefined;
  var watermarkDom = hasObserver ? new xMutationObserver(domChangeCallback) : null;
  var option = {
    childList: true,
    attributes: true,
    subtree: true,
  ...
  var loadMark = function (settings) {
    ...
    for (var i = 0; i < defaultSettings.watermark_rows; i++) {
      ...
      for (var j = 0; j < defaultSettings.watermark_cols; j++) {
        ...
        mask_div.style["white-space"]="pre-wrap";
        /*设置水印相关属性end*/
  ...
  const yMutationObserver = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver;
  var watermarkDom = new yMutationObserver(callback);
  var option = {
    childList: true,
    attributes: true,
    subtree: true,
